...
import { VaultradeLogomark as BreedskoolpiLogomark, VaultradeWordmark as BreedskoolpiWordmark } from "@/components/VaultradeLogo";
...
const VALUES = [
  ...
  },
  {
    ...
    desc: "Whether you are in Lagos, Kyiv, Buenos Aires, or Bangkok — Breedskoolpi works for you. No geographic restrictions, no sanctions checks for digital commerce.",
  },
  {
    icon: Users,
    color: "text-pink-400",
    ...
    desc: "Join thousands of developers, traders, and digital creators who buy and sell on Breedskoolpi. Our community Telegram is active 24/7.",
  },
  {
    icon: TrendingUp,
    color: "text-teal-400",
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Breedskoolpi was born from a simple frustration: buying and selling digital products online was broken. PayPal chargebacks wiped out sellers. Wire transfers locked out buyers from developing nations. Intermediaries took 30%+ cuts.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                We built Breedskoolpi to fix this. By anchoring every transaction to Pi (π) and wrapping it in our escrow layer, we give both buyers and sellers the confidence they need to trade freely — across any border, at any time.
              </p>
      ...
      <section className="py-20 border-t border-border/30 bg-card/10">
        <div className="container max-w-screen-xl mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="text-muted-foreground text-lg">Six principles that define how Breedskoolpi operates every day.</p>
          </div>
      ...
      <section className="py-20 border-t border-border/30">
        <div className="container max-w-screen-xl mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">The Team Behind Breedskoolpi</h2>
      ...
      <section className="py-20 border-t border-border/30 bg-gradient-to-br from-violet-950/30 to-blue-950/20">
        <div className="container max-w-screen-xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Trade on Breedskoolpi?</h2>
          <p className="text-xl text-muted-foreground mb-8 max-w-xl mx-auto">
            Join thousands of buyers and sellers who trust Breedskoolpi for secure, crypto-native digital commerce.
          </p>
          <div className="flex items-center justify-center gap-4 flex-wrap">
