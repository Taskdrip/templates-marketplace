      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-10">
          <Link href="/" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-primary mb-6">
            <ArrowLeft className="w-3.5 h-3.5" /> Back to Breedskoolpi.store
          </Link>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Last updated: January 1, 2025 · Breedskoolpi.store Ltd.</p>
            </div>
          </div>
          <div className="bg-card/50 border border-border/50 rounded-xl p-4 text-sm text-muted-foreground leading-relaxed">
            At <strong className="text-foreground">Breedskoolpi.store</strong>, your privacy matters. This policy explains what data we collect, why we collect it, and how we protect it. We do not sell your personal data to third parties.
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1 space-y-12 text-sm">
            <Section id="overview" title="1. Overview">
              <p>This Privacy Policy applies to all services operated by Breedskoolpi.store Ltd. ("Breedskoolpi", "we", "us", or "our"), including our website at breedskoolpi.store and all related sub-domains and applications.</p>
            ...
            <Section id="data-sharing" title="4. Data Sharing">
              ...
              <p><strong className="text-foreground">Legal Requirements:</strong> We may disclose data when required by law, court order, or government request, or to protect the rights, safety, or property of Breedskoolpi, our users, or the public.</p>
            ...
            <Section id="crypto-payments" title="5. Crypto & Blockchain Data">
              ...
              <p><strong className="text-foreground">Public Blockchain Notice:</strong> Cryptocurrency transactions are publicly recorded on the blockchain. While Breedskoolpi does not publish your wallet address, your on-chain transactions may be visible to anyone who knows your wallet address. Breedskoolpi is not responsible for blockchain-level data visibility.</p>
            ...
            <Section id="cookies" title="6. Cookie Policy">
              <p>We use cookies and similar tracking technologies to enhance your experience on Breedskoolpi.store.</p>
            ...
            <Section id="your-rights" title="8. Your Rights">
              ...
              <p>To exercise any of these rights, contact us at <a href="mailto:privacy@breedskoolpi.store" className="text-primary hover:underline">privacy@breedskoolpi.store</a>. We will respond within 30 days.</p>
            </Section>
            ...
            <Section id="security" title="9. Security">
              ...
              <p>Despite our best efforts, no system is 100% secure. If you discover a security vulnerability, please report it responsibly to <a href="mailto:security@breedskoolpi.store" className="text-primary hover:underline">security@breedskoolpi.store</a>.</p>
            </Section>

            <Section id="children" title="10. Children's Privacy">
              <p>Breedskoolpi.store is not intended for users under the age of 18. We do not knowingly collect personal information from children. If you believe a child has provided us with personal information, please contact us immediately and we will delete it.</p>
            </Section>
            ...
            <Section id="changes" title="11. Policy Changes">
              ...
              <p>Your continued use of Breedskoolpi.store after changes take effect constitutes acceptance of the revised Policy.</p>
            </Section>
            ...
            <Section id="contact-privacy" title="12. Contact">
              ...
              <div className="bg-card/50 border border-border/50 rounded-xl p-4 space-y-1">
                <p><strong className="text-foreground">Breedskoolpi.store Privacy Team</strong></p>
                <p>Email: <a href="mailto:privacy@breedskoolpi.store" className="text-primary hover:underline">privacy@breedskoolpi.store</a></p>
                <p>General Support: <Link href="/contact" className="text-primary hover:underline">breedskoolpi.store/contact</Link></p>
              </div>
            </Section>
          </div>
        </div>
