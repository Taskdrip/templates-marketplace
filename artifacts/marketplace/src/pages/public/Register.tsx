...
export default function Register() {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      toast({ title: "Welcome to DigiMarket 🎉", description: "Your account has been created successfully." });
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 py-12">
      <div className="w-full max-w-lg space-y-6 animate-in fade-in zoom-in-95 duration-500">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2 text-sm">Join thousands of buyers and sellers on DigiMarket</p>
        </div>
