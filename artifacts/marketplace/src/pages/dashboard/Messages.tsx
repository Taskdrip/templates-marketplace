...
import { useListConversations, useGetMessages, useSendMessage, useStartConversation } from "@workspace/api-client-react";
      ...
      <Card className="flex-1 flex flex-col bg-card/50 border-border/50 overflow-hidden">
        {activeId ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-muted-foreground">
            ...
            <p className="max-w-md text-center">Select a conversation from the sidebar or start a new support ticket to begin chatting.</p>
          </div>
        )}
      </Card>
    </div>
