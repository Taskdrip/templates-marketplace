        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              <ArrowDownLeft className="w-12 h-12 mx-auto mb-3 opacity-20" />
                ...
                <div key={t.id} className="flex items-center justify-between p-4 rounded-lg bg-background/50 border border-border/50">
                  ...
                  <div className="text-right">
                    ...
                    <Badge variant="outline" className={
                      t.payment?.status === 'verified' || t.payment?.status === 'confirmed' ? 'text-emerald-500 border-emerald-500/20 bg-emerald-500/10' :
